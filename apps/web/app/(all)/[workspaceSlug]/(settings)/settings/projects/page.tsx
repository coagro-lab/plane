  ...
  return (
    <div className="flex flex-col gap-4 items-center justify-center h-full max-w-[480px] mx-auto">
      ...
      <div className="text-sm text-custom-text-350 text-center">
        Projetos são a base para o trabalho orientado por objetivos. Eles permitem que você gerencie suas equipes, tarefas e tudo o que você precisa para fazer as coisas acontecerem.
      </div>
      <div className="flex gap-2">
        <Link href="https://nwerp.ai/" target="_blank" className={cn(getButtonStyling("neutral-primary", "sm"))}>
